...
These are explicitly **out**, forever, for Tangent. They live here so the
...
artifact two and beyond, not for Tangent:
...
- **Design mode for OBS** — dead as an artifact (wrong audience, hostile
  ...
  canvas / direct-manipulation surfaces that Tangent now serves.
